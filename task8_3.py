...
print(f'\nСамый теплый месяц - это {monthName(monthWarm)} (с теспературой от {warmIndex+1} до {warmIndex+7})')
print(f'Самый холодный месяц - это {monthName(monthCold)} (с теспературой от {coldIndex+1} до {coldIndex+7})')